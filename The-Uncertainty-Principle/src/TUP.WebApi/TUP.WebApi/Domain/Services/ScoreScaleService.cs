...
namespace TUP.WebApi.Domain.Services
{
    public class ScoreScaleService : IScoreScaleService
    {
       ...
       public async Task<ScoreScale> GetByIdAsync(long id)
       {
       ...
       public async Task<long> InsertAsync(ScoreScale entity)
       {
           return await this._repository.InsertAsync(entity);
       }

       public async Task UpdateAsync(long id, ScoreScale entity)
       {
